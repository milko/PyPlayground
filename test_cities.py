...
g.relateNodes("Chicago", "Saint Louis", 104)
...
print( "Shortest path from Saint Louis to Sault Ste Marie" )
x = g.leastNodes("Saint Louis", "Sault Ste Marie")
print(str(x))

print( "Least cost path from Saint Louis to Sault Ste Marie" )
x = g.leastCost("Saint Louis", "Sault Ste Marie")
print(str(x))

print("===========================")

print( "Shortest path from Las Vegas to Calgary" )
x = g.leastNodes("Las Vegas", "Calgary")
print(str(x))

print( "Least cost path from Las Vegas to Calgary" )
x = g.leastCost("Las Vegas", "Calgary")
print(str(x))
